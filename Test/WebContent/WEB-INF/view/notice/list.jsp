...
<c:set var="lastNum" value="${fn.substringBefore(listCount/10, '.')}"/>
${lastNum}
<!DOCTYPE html>
<html>
...
<head>
   ...
   <link href="/css/customer/layout.css?after" type="text/css" rel="stylesheet" />
   <style>
      #visual .content-container {a
         height: inherit;
         display: flex;
         align-items: center;
      ...
      <div class="content-container clearfix">
         ...
         <main class="main">
            ...
            <div class="indexer margin-top align-right">
               ...
               <div><span class="text-orange text-strong">${param.p }</span> / ${listCount } pages</div>
            </div>
            ...
            <div class="margin-top align-center pager">
               ...
               <c:forEach var="i" begin="0" end="4" >
                  <li>
                     ...
                     <a class="-text- ${currentStyle }" href="?p=${i+1}&f=${param.f }&q=${param.q}">${i+1}</a>
